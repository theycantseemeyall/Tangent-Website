...
window.applyCustomise = applyCustomise
window.ctxOpen = ctxOpen
window.ctxCustomise = ctxCustomise
...
window.openAddSubjectSidebar = openAddSubjectSidebar
window.confirmAddSubjectSidebar = confirmAddSubjectSidebar
window.cancelAddSubjectSidebar = cancelAddSubjectSidebar
window.openSubjectPanel = openSubjectPanel
window.examSwitchTab = examSwitchTab
window.examOpenForm = examOpenForm
window.examCloseForm = examCloseForm
window.examSaveForm = examSaveForm
window.examDelete = examDelete
window.examCalPrev = examCalPrev
window.examCalNext = examCalNext
window.examOpenImport = examOpenImport
window.examCloseImport = examCloseImport
window.examImportTab = examImportTab
window.examImportGCal = examImportGCal
window.examImportICS = examImportICS
window.examImportNotion = examImportNotion
window.ntOpenWrittenNoteEditor = ntOpenWrittenNoteEditor
window.ntSaveWrittenNote = ntSaveWrittenNote
window.ntCancelWrittenNote = ntCancelWrittenNote
window.ntWExec = ntWExec
window.ntInsertCallout = ntInsertCallout
window.notesGoBack = notesGoBack
window.notesQuickUpload = notesQuickUpload
window.enterFlashcardMode = enterFlashcardMode
window.fcStep = fcStep
window.fcShuffle = fcShuffle
window.renderNotesSubjectView = renderNotesSubjectView
window.openNotesSubject = openNotesSubject
window.pomEnterFullscreen = pomEnterFullscreen
window.pomExitFullscreen = pomExitFullscreen
window.pomFsDoToggle = pomFsDoToggle
window.pomFsDoReset = pomFsDoReset
window.pomFsDoSkip = pomFsDoSkip
window.quickStartSubject = quickStartSubject
